  ...
  return (
    <>
      <div className='flex flex-col justify-center items-center bottom-0 h-auto w-screen m-0 p-24 bg-secondary'>
        <div className='flex flex-col md:flex-row md:justify-between w-9/12 items-start p-4'>
          ...
          <div className='flex-1 flex flex-col text-center md:text-left mx-8 my-8 md:my-0'>
